...
RUN apt-get update && apt-get dist-upgrade -y && apt-get install -y lsb-release language-pack-en less emacs-nox vim wget software-properties-common apt-transport-https $(for l in ${OTHER_LANGS}; do echo language-pack-${l%%_*}; done)
